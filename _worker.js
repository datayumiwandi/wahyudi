...
// Variables
const rootDomain = "mujinah200.workers.dev"; // Ganti dengan domain utama kalian
const serviceName = "wahyudi"; // Ganti dengan nama workers kalian
